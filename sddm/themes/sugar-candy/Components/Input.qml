...
Column {
    ...
    Item {
        ...
        ComboBox {
            ...
            textRole: "name"
            // The default ComboBox contentItem renders displayText ("Alucado")
            // clipped to this square box — a stray "A" behind the user icon.
            displayText: ""
            hoverEnabled: true
            onActivated: {
        ...
        TextField {
            id: username
            text: config.ForceLastUser == "true" ? (selectUser.currentText || userModel.lastUser) : null
